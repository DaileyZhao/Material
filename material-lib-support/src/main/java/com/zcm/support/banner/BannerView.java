package com.zcm.support.banner;
...
import com.zcm.support.banner.transformer.CustomTransformer;
...
public class BannerView<T> extends RelativeLayout {
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link BannerView {@link #setPages(List, PagerHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start(){
     ...
     * @param mzHolderCreator  ViewHolder生成器 {@link PagerHolderCreator} And {@link PagerViewHolder}
     */
    public void setPages(List<T> datas, PagerHolderCreator mzHolderCreator){
    ...
    public static class  MZPagerAdapter<T> extends PagerAdapter {
        private List<T> mDatas;
        private PagerHolderCreator mMZHolderCreator;
        private ViewPager mViewPager;
        private boolean canLoop;
        private BannerPageClickListener mPageClickListener;
        private final int mLooperCountFactor = 500;

        public MZPagerAdapter(List<T> datas, PagerHolderCreator MZHolderCreator, boolean canLoop) {
            if(mDatas == null){
